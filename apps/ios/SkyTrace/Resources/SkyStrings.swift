...
enum SkyStrings {
    ...
    private static let general: [String: Pair] = [
        ...
        "action.viewOnMap": .init(ja: "地図で見る", en: "View on map"),
        ...
        "case.currentState": .init(ja: "現時点", en: "Where it stands"),
        "case.nav.overview": .init(ja: "概要", en: "Overview"),
        "case.nav.assessment": .init(ja: "評価", en: "Assessment"),
        "case.nav.evidence": .init(ja: "資料", en: "Evidence"),
        "case.nav.timeline": .init(ja: "経緯", en: "Timeline"),
        "case.nav.sources": .init(ja: "出典", en: "Sources"),
        "case.nav.hint": .init(ja: "セクションへ移動", en: "Jump to section"),
        "case.leadingExplanation": .init(ja: "有力な説明候補：%@", en: "Leading explanation: %@"),
        "case.openPoint": .init(ja: "未解決の点：%@", en: "Open point: %@"),
        "pulse.metric.new": .init(ja: "新規報告", en: "New reports"),
        "pulse.metric.merged": .init(ja: "統合事例", en: "Merged cases"),
        "pulse.metric.updated": .init(ja: "評価更新", en: "Reassessed"),
        "label.updatedCount": .init(ja: "更新%@件", en: "%@ updated"),
        "evidence.kind.officialRecord": .init(ja: "公式記録", en: "Official record"),
        "evidence.kind.instrumentData": .init(ja: "観測・計測データ", en: "Instrument data"),
        "evidence.kind.databaseRecord": .init(ja: "データベース記録", en: "Database record"),
        "evidence.kind.openData": .init(ja: "オープンデータ", en: "Open data"),
        "evidence.captured": .init(ja: "記録日 %@", en: "Recorded %@"),
        "search.reason.title": .init(ja: "タイトルが一致", en: "Title match"),
        "search.reason.location": .init(ja: "場所が一致", en: "Location match"),
        "search.reason.shape": .init(ja: "形状・タイプが一致", en: "Shape/type match"),
        "search.reason.summary": .init(ja: "概要が一致", en: "Summary match"),
        "search.reason.source": .init(ja: "出典が一致", en: "Source match"),
    ...
    private static let settings: [String: Pair] = [
        ...
        "settings.section.refresh": .init(ja: "自動更新", en: "Auto-refresh"),
        "settings.refresh.auto": .init(ja: "自動で更新", en: "Refresh automatically"),
        "settings.refresh.note": .init(
            ja: "アプリに戻ったときと、開いている間は一定間隔で最新情報を取得します。",
            en: "Fetches the latest when you return to the app and periodically while it's open."),
        "settings.refresh.interval": .init(ja: "更新間隔", en: "Interval"),
        "settings.refresh.interval.min2": .init(ja: "2分", en: "2 min"),
        "settings.refresh.interval.min5": .init(ja: "5分", en: "5 min"),
        "settings.refresh.interval.min15": .init(ja: "15分", en: "15 min"),
        ...
        "settings.cache.recents": .init(ja: "最近見た事例", en: "Recently viewed"),
        "settings.cache.count": .init(ja: "%@件", en: "%@ items"),
        "settings.cache.note": .init(ja: "ブックマークは消去されません（別操作）。", en: "Bookmarks are kept (a separate action)."),
        "settings.cache.confirmTitle": .init(ja: "最近見た事例を消去しますか？", en: "Clear recently viewed?"),
        "settings.cache.confirmMessage": .init(ja: "最近見た事例の履歴だけを消去します。ブックマークは残ります。",
                                               en: "Clears the recently-viewed history only. Bookmarks are kept."),
        "settings.notif.status": .init(ja: "通知の許可", en: "Notifications"),
        "settings.notif.enable": .init(ja: "通知を有効にする", en: "Enable notifications"),
        "settings.notif.openSettings": .init(ja: "システム設定を開く", en: "Open system settings"),
        "settings.notif.deniedNote": .init(
            ja: "通知はシステム設定でオフになっています。設定アプリから許可できます。",
            en: "Notifications are off in system settings. You can allow them in the Settings app."),
        "notif.state.notDetermined": .init(ja: "未設定", en: "Not set"),
        "notif.state.denied": .init(ja: "オフ", en: "Off"),
        "notif.state.authorized": .init(ja: "許可", en: "Allowed"),
        "notif.state.provisional": .init(ja: "簡易", en: "Provisional"),
        "action.cancel": .init(ja: "キャンセル", en: "Cancel"),
